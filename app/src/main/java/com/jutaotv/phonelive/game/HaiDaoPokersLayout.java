package com.jutaotv.phonelive.game;
...
import com.jutaotv.phonelive.ui.other.DrawableRes;
...
public class HaiDaoPokersLayout extends RelativeLayout {
    ...
    public void initGameView() {
        ...
        removeView(mView);
        mView = View.inflate(mContext, R.layout.view_game_haidao_pokers, null);

        addView(mView);
        initView(mView);

        if (mGameInterface != null) {
            mGameInterface.onInitGameView(2);
        }
    ...
    private void init(Context ct) {
        ...
        mContext = ct;
        mView = View.inflate(ct, R.layout.view_game_haidao_pokers, null);

        res.put(5, R.drawable.icon_game_haidao_nw);
        res.put(1, R.drawable.icon_game_haidao_ny);
        res.put(0, R.drawable.icon_game_haidao_mn);
        res.put(2, R.drawable.icon_game_haidao_ne);
        res.put(3, R.drawable.icon_game_haidao_ns);
        res.put(4, R.drawable.icon_game_haidao_nsi);
        res.put(6, R.drawable.icon_game_haidao_nl);
        res.put(7, R.drawable.icon_game_haidao_nq);
        res.put(8, R.drawable.icon_game_haidao_nb);
        res.put(9, R.drawable.icon_game_haidao_nj);
        res.put(10, R.drawable.icon_game_haidao_nn);
        res.put(11, R.drawable.icon_game_haidao_shn);
        res.put(12, R.drawable.icon_game_haidao_whn);
        res.put(13, R.drawable.icon_game_haidao_wxn);
    ...
    private void initView(View view) {
        ...
        mLlGameDq = (RelativeLayout) view.findViewById(R.id.ll_game_jack);
        mLlGameDc = (RelativeLayout) view.findViewById(R.id.ll_game_center);
        mLlGameXq = (RelativeLayout) view.findViewById(R.id.ll_game_anna);
        ...
        mTvBetting1 = (TextView) view.findViewById(R.id.tv_game_pokers_jack_2);
        mTvBetting2 = (TextView) view.findViewById(R.id.tv_game_pokers_pj_2);
        mTvBetting3 = (TextView) view.findViewById(R.id.tv_game_pokers_anna_2);

        mTvTotalBetting1 = (TextView) view.findViewById(R.id.tv_game_pokers_jack_1);
        mTvTotalBetting2 = (TextView) view.findViewById(R.id.tv_game_pokers_pj_1);
        mTvTotalBetting3 = (TextView) view.findViewById(R.id.tv_game_pokers_anna_1);
        ...
        view.findViewById(R.id.rl_game_betting_1).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(1, 2);
                }
            }
        });
        ...
        view.findViewById(R.id.rl_game_betting_2).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(2, 2);
                }
            }
        });
        ...
        view.findViewById(R.id.rl_game_betting_3).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(3, 2);
                }
            }
        });
        ...
        mBtnGameStart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mGameInterface != null) {
                    mGameInterface.onClickStartGame(2);
                }
            }
        });
        ...
        mBtnGameClose.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickCloseGame(2);
                }
            }
        });
                ...
                public void onClick(View view) {
                    ...
                    if (mGameInterface != null) {
                        if (view.getId() == mIvSelectBettingBtn[0].getId())
                            mGameInterface.onSelectBettingNum(10, 2);
                        if (view.getId() == mIvSelectBettingBtn[1].getId())
                            mGameInterface.onSelectBettingNum(100, 2);
                        if (view.getId() == mIvSelectBettingBtn[2].getId())
                            mGameInterface.onSelectBettingNum(1000, 2);
                        if (view.getId() == mIvSelectBettingBtn[3].getId())
                            mGameInterface.onSelectBettingNum(10000, 2);
                    }
...
//            mLlGameDc.animate().scaleX(0.7f).scaleY(0.7f).translationY(100f).setDuration(0).start();
        ...
        mLlGameDc.getChildAt(0).setVisibility(GONE);
        ...
        mLlGameContent.getChildAt(2).setVisibility(VISIBLE);
    ...
    public void startGame() {
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartGameCommit(2);
        }
        ...
        mLlGameXq.animate().scaleX(0.7f).scaleY(0.7f).translationY(ty)
                .withEndAction(new Runnable() {
                    ...
                    public void run() {
                        ...
                        mLlGameDq.getChildAt(1).setVisibility(VISIBLE);
                        mLlGameDc.getChildAt(0).setVisibility(GONE);
                        mLlGameXq.getChildAt(1).setVisibility(VISIBLE);

                        mLlGameDq.getChildAt(0).setVisibility(GONE);
                        mLlGameXq.getChildAt(0).setVisibility(GONE);
    ...
    private void startLicensing() {
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartLicensing(2);
        }


        mPokersGroup = new RelativeLayout[2];
        ...
        for (int s = 0; s < 2; s++) {
            ...
            while (i < 5) {
                ...
                LayoutParams params = new LayoutParams((int) TDevice.dpToPixel(40), (int) TDevice.dpToPixel(45));
                params.setMargins(i * margin, 10, 0, 0);

                pokers.setImageResource(R.drawable.poker_back);
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartCountDown(2);
            readyGame(0);
        }
    }
    ...
    public void startCountDown(int time) {
        ...
        new CountDownTimer(time * 1000, 1000) {
            ...
            public void onFinish() {
                readyGame(1);
                if (mGameInterface != null) {
                    mGameInterface.onEndCountDown(2);
                }
            }
    ...
    public void showResult(final int index, String p1, String p2, String p3, String p4, String p5, int str, int isWinning) {
        ...
        if (index != 1) {
            ...
            if (mPokersGroup.length != 0)
                for (int s = 0; s < mPokersGroup[index1].getChildCount(); s++) {
                    int idx = (StringUtils.toInt(p1Img[s][0]) - 1) * 14 + StringUtils.toInt(p1Img[s][1]) - 1;
                    ((ImageView) mPokersGroup[index1].getChildAt(s)).setImageResource(DrawableRes.PokersImg[idx]);
                }


            ImageView name = new ImageView(mContext);

            LayoutParams params = new LayoutParams((int) TDevice.dpToPixel(100), (int) TDevice.dpToPixel(60));
            ...
            if (index == 0) {
                ...
                params.setMargins((int) TDevice.dpToPixel(30), 0, 0, 0);
            } else {
                params.addRule(RelativeLayout.ALIGN_PARENT_RIGHT);
                params.setMargins(0, 0, (int) TDevice.dpToPixel(30), 0);
            }
            ...
            animatorSet.addListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    if (mGameInterface != null && index == 2) {
                        mGameInterface.onShowResultEnd(2);
                    }
                }
