...
public class JinHuaPokersLayout extends RelativeLayout {
    ...
    public JinHuaPokersLayout(Context context) {
        super(context);

        init(context);
    }

    public JinHuaPokersLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public JinHuaPokersLayout(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initGameView() {
        ...
        if (mGameInterface != null) {
            mGameInterface.onInitGameView(1);
        }
    ...
    private void init(Context ct) {
        ...
        res.put(6, R.drawable.icon_game_pokers_bz);
        res.put(2, R.drawable.icon_game_pokers_dz);
        res.put(1, R.drawable.icon_game_pokers_szdl);
        res.put(3, R.drawable.icon_game_pokers_sz);
        res.put(4, R.drawable.icon_game_pokers_th);
        res.put(5, R.drawable.icon_game_pokers_ths);
    ...
    private void initView(View view) {
        ...
        view.findViewById(R.id.rl_game_betting_1).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(1, 1);
                }
            }
        });
        ...
        view.findViewById(R.id.rl_game_betting_2).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(2, 1);
                }
            }
        });
        ...
        view.findViewById(R.id.rl_game_betting_3).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(3, 1);
                }
            }
        });
        ...
        mBtnGameStart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mGameInterface != null) {
                    mGameInterface.onClickStartGame(1);
                }
            }
        });
        ...
        mBtnGameClose.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickCloseGame(1);
                }
            }
        });
                ...
                public void onClick(View view) {
                    ...
                    if (mGameInterface != null) {
                        if (view.getId() == mIvSelectBettingBtn[0].getId())
                            mGameInterface.onSelectBettingNum(10, 1);
                        if (view.getId() == mIvSelectBettingBtn[1].getId())
                            mGameInterface.onSelectBettingNum(100, 1);
                        if (view.getId() == mIvSelectBettingBtn[2].getId())
                            mGameInterface.onSelectBettingNum(1000, 1);
                        if (view.getId() == mIvSelectBettingBtn[3].getId())
                            mGameInterface.onSelectBettingNum(10000, 1);
                    }
    ...
    public void setGameStatusOnHaveInHand(String downCount) {
        int ty = (int) TDevice.dpToPixel(35);
            mLlGameDq.animate().scaleX(0.7f).scaleY(0.7f).translationY(ty).setDuration(0).start();
            mLlGameDc.animate().scaleX(0.7f).scaleY(0.7f).translationY(ty).setDuration(0).start();
            mLlGameXq.animate().scaleX(0.7f).scaleY(0.7f).translationY(ty).setDuration(0).start();
    ...
    public void startGame() {
        ...
        int ty = (int) TDevice.dpToPixel(35);
        mLlGameDq.animate().scaleX(0.7f).scaleY(0.7f).translationY(ty).setDuration(4000).start();
        mLlGameDc.animate().scaleX(0.7f).scaleY(0.7f).translationY(ty).setDuration(4000).start();
    ...
    private void startLicensing() {
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartLicensing(1);
        }
        readyGame(0);
        ...
        for (int s = 0; s < 3; s++) {
            ...
            while (i < 3) {
                ...
                pokers.setImageResource(R.drawable.icon_poker_back_goldflower);
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartCountDown(1);
        }
    }
    ...
    public void readyGame(int i) {
        ...
        RelativeLayout.LayoutParams params = new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, (int) TDevice.dpToPixel(30));
...
//        mIvReady.animate()
    ...
    public void resultGame() {
        ...
        RelativeLayout.LayoutParams params = new LayoutParams((int) TDevice.dpToPixel(200), (int) TDevice.dpToPixel(100));
    ...
    public void startCountDown(int time) {
        ...
        new CountDownTimer(time * 1000, 1000) {
            ...
            public void onFinish() {
                readyGame(1);
                if (mGameInterface != null) {
                    mGameInterface.onEndCountDown(1);
                }
            }
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (mGameInterface != null && index == 2) {
                    mGameInterface.onShowResultEnd(1);
                }
            }
